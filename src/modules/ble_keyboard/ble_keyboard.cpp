...
void BleKeyboardModule::begin(TFT_eSPI &tft) {
...
void BleKeyboardModule::loop(TFT_eSPI &tft) {
    // Chamado continuamente enquanto o app estiver aberto.
    // TODO
}

void BleKeyboardModule::onTouch(TFT_eSPI &tft, int16_t x, int16_t y) {
    // Chamado quando o usuario toca na tela dentro do app.
    // TODO
}

void BleKeyboardModule::end() {
