...
// ============================================================
//  MODULO: BLE Scanner
//  Implemente a logica em ble_scanner.cpp
//  Voce so precisa mexer nestes 2 arquivos - o loader
//  (main.cpp) e o ModuleRegistry nao precisam ser alterados.
// ============================================================
class BleScannerModule : public AppModule {
public:
    const char* getName() override { return "BLE Scanner"; }
    uint16_t getColor() override { return TFT_GREENYELLOW; }
