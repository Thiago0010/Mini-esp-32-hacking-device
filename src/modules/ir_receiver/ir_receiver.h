...
// ============================================================
//  MODULO: Receptor IR
//  Implemente a logica em ir_receiver.cpp
//  Voce so precisa mexer nestes 2 arquivos - o loader
//  (main.cpp) e o ModuleRegistry nao precisam ser alterados.
// ============================================================
class IrReceiverModule : public AppModule {
public:
    const char* getName() override { return "Receptor IR"; }
    uint16_t getColor() override { return TFT_OLIVE; }
