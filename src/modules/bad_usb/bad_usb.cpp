...
void BadUsbModule::begin(TFT_eSPI &tft) {
...
void BadUsbModule::loop(TFT_eSPI &tft) {
    // Chamado continuamente enquanto o app estiver aberto.
    // TODO
}

void BadUsbModule::onTouch(TFT_eSPI &tft, int16_t x, int16_t y) {
    // Chamado quando o usuario toca na tela dentro do app.
    // TODO
}

void BadUsbModule::end() {
