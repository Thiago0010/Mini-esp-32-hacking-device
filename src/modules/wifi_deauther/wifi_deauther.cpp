...
void WifiDeautherModule::begin(TFT_eSPI &tft) {
...
void WifiDeautherModule::loop(TFT_eSPI &tft) {
    // Chamado continuamente enquanto o app estiver aberto.
    // TODO
}

void WifiDeautherModule::onTouch(TFT_eSPI &tft, int16_t x, int16_t y) {
    // Chamado quando o usuario toca na tela dentro do app.
    // TODO
}

void WifiDeautherModule::end() {
